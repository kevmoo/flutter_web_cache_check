...
class ChromeSession {
  ...
  void _onResponseReceived(Map<String, Object?> params) {
    ...
    final headers = (response['headers'] as Map<String, Object?>?) ?? const {};
  ...
  void _onConsoleApiCalled(Map<String, Object?> params) {
    final type = params['type'] as String;
    final args = (params['args'] as List<Object?>? ?? const [])
        .cast<Map<String, Object?>>()
        .map(
          (a) => a['value']?.toString() ?? a['description']?.toString() ?? '',
        )
        .join(' ');
  ...
  void _onLogEntryAdded(Map<String, Object?> params) {
  ...
  void _onWorkerVersionUpdated(Map<String, Object?> params) {
    for (final v
        in (params['versions'] as List<Object?>).cast<Map<String, Object?>>()) {
